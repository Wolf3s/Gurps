...
int main()
{
    static unsigned short ST = 10, DX = 10, IQ = 10, HT = 10, HP = ST, Will = IQ, Per = IQ, FP = HT, current_HP = 10;
    ...
    while(true)
    {
        ...
        // Calculation of basic lift encumbrance.
        ...
        shortcuts(&ST, &DX, &IQ, &HT, &HP, &Will, &Per, &FP);
    }
	return 0;
}